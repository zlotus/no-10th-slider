...
export function Slide10({ step }: SlideProps) {
  return <Slide number="10" eyebrow="SYSTEM MAP · HERO" title="一个完整 Coding Agent" className="slide-10">
    ...
    <motion.div className="system-equation" animate={{ opacity: step >= 4 ? 1 : 0, y: step >= 4 ? 0 : 10 }}><b>Model</b><i>+</i><b>Context</b><i>+</i><b>Tools</b><i>+</i><b>Harness</b><i>+</i><b>Loop</b><span>=</span><strong>Agent System</strong></motion.div>
  </Slide>
}
